...
<div class="card mt-5">
  ...
  <div class="card-body">
    <!-- Form -->
<form method="post" action="form-proses2.php">
  <div class="form-group">
    <label for="exampleInputNama">Nama Ayah</label>
    <input  class="mr-5" name="nama_ayah" type="text" id="exampleInputNama" style="background-color: #444; color:antiquewhite;">  
  </div>
  <div class="form-group">
    <label for="exampleInputTanggal">Tanggal Lahir Ayah</label>
    <input class="mr-5" name="tanggal_ayah" type="date" id="exampleInputTanggal" style="background-color: #444; color:antiquewhite;">  
  </div>
  <div class="form-group">
    <label for="exampleInputNama">Nama Ibu</label>
    <input type="text" name="nama_ibu" id="exampleInputNama" style="background-color: #444; color:antiquewhite;">  
  </div>
  <div class="form-group">
    <label for="exampleInputTanggal">Tanggal Lahir Ibu</label>
    <input class="mr-5" name="tanggal_ibu" type="date" id="exampleInputTanggal" style="background-color: #444; color:antiquewhite;">
  </div>
